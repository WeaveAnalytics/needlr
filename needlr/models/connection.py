...
# Role_Principal.model_rebuild()
# Role_ServicePrincipalProfileDetails.model_rebuild()
...
# class Credentials_Cloud(BaseModel):
#     credentialType: str
#     username: str
#     password: str
...
# class Credentials_OnPrem(BaseModel):
#     credentialType: str
#     values: List[Value]

# class Credentials_VNet(BaseModel):
#     credentialType: str
#     username: str
#     password: str
...
#     connectionEncryption: str
#     skipTestConnection: bool
#     credentials: Union[Credentials_Cloud, Credentials_OnPrem, Credentials_VNet]


# class Connection_Create_Cloud(BaseModel):
#     connectivityType: str
#     displayName: str
...
# class Connection_Create_OnPrem(BaseModel):
#     connectivityType: str
#     gatewayId: str
#     displayName: str
#     connectionDetails: ConnectionDetails
...
# class Connection_Create_VNet(BaseModel):
#     connectivityType: str
#     gatewayId: str
#     displayName: str
#     connectionDetails: ConnectionDetails
...
# class Connection_Create_CredentialDetails(BaseModel):
#     connectionEncryption: EncryptionType
#     credentials: Union[Credential_Anonymous, Credential_BasicCredentials, Credential_Key
#                        , Credential_ServicePrincipal, Credential_SharedAccessSignature
#                        , Credential_Windows, Credential_WindowsWithoutImpersonation
#                        , Credential_WorkspaceIdentity]
#     singleSignOnType: ConnectionDetails #TODO
#     skipTestConnection: bool
